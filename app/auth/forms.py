...
class ChangePasswordForm(FlaskForm):
	oldpassword = PasswordField('原密码',validators = [DataRequired(),Length(2,64)],render_kw={"placeholder": "请输入你的原密码"})
	newpassword = PasswordField('新的密码',validators = [DataRequired(),EqualTo('newpassword2',message = "密码不一致"),Length(2,64)],render_kw={"placeholder": "请输入你新的密码"})
	newpassword2 =PasswordField('再输入一遍',validators = [DataRequired(),Length(2,64)],render_kw={"placeholder": "请确认你新的密码"})
